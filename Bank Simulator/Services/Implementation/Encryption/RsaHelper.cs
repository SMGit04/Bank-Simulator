...
namespace Bank_Simulator.Services.Implementation.Encryption
{
    public class RsaHelper
    {
        ...
        public RsaHelper()
        {
            ...
            _privateKey = GetPrivateKeyFromFile(privateKeyFilePath);
            _publicKey = GetPublicKeyFromFile(publicKeyFilePath);
        }
        ...
        private RSACryptoServiceProvider GetPrivateKeyFromFile(string privateKeyPem)
        {
        ...
        private RSACryptoServiceProvider GetPublicKeyFromFile(string publicKeyPem)
        {
